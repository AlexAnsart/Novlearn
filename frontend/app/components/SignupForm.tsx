        ...
        >
          ...
          <div className="flex items-start gap-3">
            <input
              ...
              required
              className="mt-1 w-5 h-5 rounded border-slate-600 bg-slate-900/60 text-green-500 focus:ring-2 focus:ring-green-500"
            />
            <label
              htmlFor="consent"
