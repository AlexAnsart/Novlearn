...
export function ValidationResult({ status, onNewExercise }: ValidationResultProps) {
  ...
  return (
    <div
      className={`fixed left-0 md:left-24 right-0 bottom-0 bg-gradient-to-r ${bg} flex flex-col md:flex-row items-center justify-between px-4 md:px-12 py-6 md:py-8 gap-4 transition-all duration-700 ease-out ${
