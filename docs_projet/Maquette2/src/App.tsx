...
type Tab = "home" | "progress" | "classes" | "training" | "settings" | "account" | "course" | "duel" | "signup";
...
export default function App() {
  ...
  const [hasFriendRequests] = useState(true); // Notification pour demandes d'amis
        ...
        {!isMobile && (
          <div className="flex flex-1">
            ...
            <div className="flex-1 flex flex-col">
              ...
              {!isFullScreen && (
                <div className="p-8 flex items-center justify-between">
                  ...
                  >
                    ...
                    {hasFriendRequests && (
                      <div className="absolute top-2 left-2 w-3 h-3 bg-red-500 rounded-full border-2 border-slate-900" />
                    )}
                    <span
                ...
                <div className="flex-1 flex items-center justify-center px-8 pb-8">
                  <div className="max-w-4xl w-full space-y-8">
                    ...
                    <div className="flex items-center justify-center gap-8 flex-wrap">
                      <ActionButton variant="primary" icon="⚔️" onClick={() => setActiveTab("duel")}>
                        1VS1
                      </ActionButton>
              ...
              {activeTab === "training" && !isFullScreen && <TrainingPage />}
